package com.thiagopaiva.xyzreader.data;

import android.net.Uri;

public class ItemsContract {
	public static final String CONTENT_AUTHORITY = "com.thiagopaiva.xyzreader";
	public static final Uri BASE_URI = Uri.parse("content://com.thiagopaiva.xyzreader");
	...
	public static class Items implements ItemsColumns {
		public static final String CONTENT_TYPE = "android.cursor.dir/com.thiagopaiva.xyzreader.items";
		public static final String CONTENT_ITEM_TYPE = "android.cursor.item/com.thiagopaiva.xyzreader.items";
